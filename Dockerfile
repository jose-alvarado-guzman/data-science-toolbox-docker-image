...
RUN /bin/bash -c "source /usr/local/bin/virtualenvwrapper.sh && mkproject DS_Training && pip install ipykernel matplotlib plotnine && ipython kernel install --user --name=Python3_DS_Training && mv ${HOME}/fuel_efficiency_analysis_using_R.ipynb ."
